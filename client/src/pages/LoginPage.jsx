...
export default function LoginPage({ onAuth }) {
  ...
  return (
    <div className="space-y-4">
      <div className="px-1">
        <p className="text-xs font-black uppercase tracking-[0.16em] text-market-emerald">Welcome back</p>
        <h1 className="text-2xl font-black text-market-navy">Login</h1>
      </div>
      <form onSubmit={submit} className="glass-panel space-y-3 rounded-[1.35rem] p-4">
        ...
        <p className="text-center text-sm text-gray-600">
          New here?{" "}
          <Link to="/register" className="font-bold text-market-emerald">
            Create an account
          </Link>
        </p>
      </form>
